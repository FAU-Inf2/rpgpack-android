...
import de.fau.cs.mad.rpgpack.ReattachingPopup;
import de.fau.cs.mad.rpgpack.SlideoutNavigationActivity;
import de.fau.cs.mad.rpgpack.character.CustomExpandableListAdapter;
import de.fau.cs.mad.rpgpack.jackson.CheckBoxClass;
import de.fau.cs.mad.rpgpack.jackson.ColumnHeader;
import de.fau.cs.mad.rpgpack.jackson.IEditableContent;
import de.fau.cs.mad.rpgpack.jackson.PopupClass;
import de.fau.cs.mad.rpgpack.jackson.StringClass;
import de.fau.cs.mad.rpgpack.jackson.Table;
import de.fau.cs.mad.rpgpack.matrix.MatrixFragment;
import de.fau.cs.mad.rpgpack.matrix.MatrixItem;
...
//    }
    ...
    private ArrayList<String> getAllElementsToRef(FolderFragment fragmentToSearch){
    	...
    	if(fragmentToSearch.dataAdapter != null){
    		Log.d("popupReferences", "subdirs: " + fragmentToSearch.dataAdapter.getAll().length);
    		for(FolderElementData currentDatum  : fragmentToSearch.dataAdapter.getAll()){
    			GeneralFragment currentFragment = currentDatum.childFragment;
    			if(currentFragment instanceof FolderFragment){
